#include "MagneticFieldEventJavaClass.h"

#define CONSTRUCTOR_METHOD_NAME "<init>"

#define ENTITY_CLASS "com/develop/zuzik/androidndksensor/ndk/sensorEvent/MagneticFieldEvent"
...
MagneticFieldEventJavaClass::MagneticFieldEventJavaClass(JNIEnv *env) {
...
jobject MagneticFieldEventJavaClass::constructor(JNIEnv *env) {
    return env->NewObject(this->entityClass,
                          this->constructorMethodId);
}

void MagneticFieldEventJavaClass::update(JNIEnv *env,
